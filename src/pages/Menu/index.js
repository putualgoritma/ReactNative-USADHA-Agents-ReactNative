      ...
      <HeaderComponent/>
        <ScrollView>
          {/* <View style={styles.menu}>
            ...
            <SubMenu
              titleMenu="Pendaftaran Mitra Langsung / Downline"
              icon="user-plus"
          ...
          <View style={styles.menu}>
            <Text style={styles.titleMenu}>Agen Stok</Text>
            <SubMenu 
              titleMenu="Agen Stok" 
              icon="inbox" 
              navigasi={() => navigation.navigate('AgenStok')}
            />
          </View>
          <View style={styles.menu}>
          ...
          <View style={styles.menu}>
            <Text style={styles.titleMenu}>UBB Mart2</Text>
            <SubMenu 
              titleMenu="UBB Mart2" 
              icon="shopping-bag" 
              navigasi={() => navigation.navigate('Mart')}
            />
          </View>
          <View style={styles.menu}>
            <Text style={styles.titleMenu}>Transfer Stok</Text>
            <SubMenu 
              titleMenu="Transfer Stok" 
              icon="upload" 
              navigasi={() => navigation.navigate('TransferStock')}
            />
          </View>
          <View style={styles.menu}>
            <Text style={styles.titleMenu}>Generate Token</Text>
            <SubMenu 
              titleMenu="Generate Token" 
              icon="key" 
              navigasi={() => navigation.navigate('Tokenize')}
            />
          </View>
        </ScrollView>
      </View>
